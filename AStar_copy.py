...
class AStar:
    def __init__(self, start, goal, h, k, w1, w2, w3):
        ...
        :param goal: str
        :param h: int
        :param k: float 启发式在估价函数中的比例
        :param w1: float h1的比例
        :param w2: float h2的比例
        :param w3: float h3的比例
        """
    ...
    def h_cost(self, now, goal):
        ...
        # elif self.h == 4:
        #     return self.h4
        return self.k * (self.w1 * self.h1(now, goal) + self.w2 * self.h2(now, goal) + self.w3 * self.h3(now, goal))
